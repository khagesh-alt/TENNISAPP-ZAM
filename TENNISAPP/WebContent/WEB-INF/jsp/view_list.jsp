...
<main id="main" style="margin-top: 100px;">
   ...
   <section id="portfolio" class="" style="padding: 0px !important;" >
      <div class="container">

        <header class="section-header">
          <h3 class="section-title" style="color: #fff;">Tournaments</h3>
        </header>

        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              <li ng-class="liveClass" ng-click="filterFun(false)">Live</li>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item fadeInUp" ng-repeat="list in tournamentCategoryDetails | filter:{live:liveOrUpcoming}">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style ="padding: 0px;">
         ...
         <!--  <div class="col-lg-6"><button class="btn btn-info" style="background: #18d26e;float:right;" ng-click="registerForTournament(tournament.tournamentId);"> Register</button></div> -->
           <div class="col-lg-6"><a href="redirectToShowTournament?tournamentId={{tournament.tournamentId}}" target="_blank" class="btn btn-success" style="float:right;">More..</a></div>
          </c:if>
          <c:if test="${sessionScope['scopedTarget.userSession'].loginType == NAN}">
          <div class="col-lg-6"><button class="btn btn-success" style="float:right;" data-toggle="modal" data-target="#loginOrRegisterModel"> More..</button></div>
          </c:if>
        </div>
        </div>
      </div>
...
<input type="hidden" name="popupmsg" id="popupmsg" value="${message}" />
  ...
  <script  src="resources/javascript/custom/view_list.js" ></script>
